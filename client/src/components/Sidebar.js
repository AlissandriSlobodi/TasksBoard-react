...
function Sidebar({ isSideBarOpen, setIsSideBarOpen }) {
  ...
  return (
    <div>
            ...
            <div className="dropdown-borad flex flex-col h-[70vh] justify-between">
              <div>
                ...
                >
                  <img
                    src={addIcon}
                    className="filter-black h-5 flex-none"
                    alt="icon"
                  />
      ...
      {!isSideBarOpen && (
        <div className="bg-[#635FC7] dark:bg-[#2b2c37] dark:hover:bg-[#635FC7] top-auto bottom-10 justify-center items-center hover:opacity-80 cursor-pointer p-0 transition duration-300 transform fixed flex w-[56px] h-[48px] rounded-r-full">
          <div className="p-5" onClick={() => toggleSidebar()}>
